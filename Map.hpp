...
namespace ft
{
	...
	class map
	{
	    ...
	    typedef typename allocator_type::difference_type									difference_type;
			...
			mapped_type &	at(const key_type & n) {
				if (n >= this->size())
					throw (std::length_error("vector::at: " + std::to_string(n) + " Out of bounds"));
				return (*this)[n];
			};
			
			const mapped_type &	at(const key_type & n) const {
				if (n >= this->size())
					throw (std::length_error("vector::at: " + std::to_string(n) + " Out of bounds"));
				return (*this)[n];
			};
			...
			iterator	begin(void)
				{ return iterator(bst.sentinel_node->left, bst.sentinel_node); };
			
			const_iterator	begin(void) const
				{ return iterator(bst.sentinel_node->left, bst.sentinel_node); };
				
			iterator	end(void)
				{ return iterator(bst.sentinel_node, bst.sentinel_node); };
			...
			bool	empty(void) const
				{ return bst.sentinel_node->parent == bst.sentinel_node; };
			...
			iterator	find(const key_type & key)
				{ return iterator(bst.searchByKey(ft::make_pair(key, mapped_type())), bst.sentinel_node); };
				
			const_iterator	find(const key_type & key) const
				{ return const_iterator(bst.searchByKey(ft::make_pair(key, mapped_type())), bst.sentinel_node); };
